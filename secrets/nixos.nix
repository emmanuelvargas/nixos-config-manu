  ...
  config = mkIf (cfg.desktop.enable || enabledServerSecrets) (mkMerge [
    ...
    (mkIf cfg.desktop.enable {
      age.secrets = {
        ...
        "manu-gpg-subkeys.priv.age" =
          {
            file = "${mysecrets}/manu-gpg-subkeys-2025-04-27.priv.age.age";
          }
          // noaccess;
        ...
        "manu-gpg-keys-2025-05-27.pub" =
          {
            file = "${mysecrets}/public/manu-gpg-keys-2025-01-27.pub.age";
          }
          // user_readable;
      ...
      environment.etc = {
        ...
        "agenix/manu-gpg-subkeys.priv.age" = {
          source = config.age.secrets."manu-gpg-subkeys.priv.age".path;
          mode = "0000";
        };
